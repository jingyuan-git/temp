...
//func fullPath (walkJudge *[][]bool,grid [][]byte, i ,j int)  {
//	if i > 0 && i < len(grid) && j > 0 && j < len(grid[0]){
//		fmt.Println("111")
//		if grid[i][j] == '1' && (*walkJudge)[i][j] == false{
//			fmt.Println("222", walkJudge)
//			(*walkJudge)[i][j] = true
//			fullPath(walkJudge, grid, i-1, j)
//			fullPath(walkJudge, grid, i+1, j)
//			fullPath(walkJudge, grid, i, j+1)
//			fullPath(walkJudge, grid, i, j-1)
//		}
//	}
//
