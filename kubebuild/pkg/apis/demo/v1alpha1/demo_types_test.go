...
import (
	...
	. "temp/kubebuild/pkg/apis/demo/v1alpha1"
	. "temp/kubebuild/pkg/client/clientset_generated/clientset/typed/demo/v1alpha1"
)

var _ = Describe("Demo", func() {
	var instance Demo
	var expected Demo
	var client DemoInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.DemoV1alpha1().Demos("demo-test-valid")
